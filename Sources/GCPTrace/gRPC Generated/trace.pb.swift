...
extension Google_Devtools_Cloudtrace_V2_Span.SpanKind: CaseIterable {
  ...
  static var allCases: [Google_Devtools_Cloudtrace_V2_Span.SpanKind] = [
    .unspecified,
    .internal,
    .server,
    .client,
...
extension Google_Devtools_Cloudtrace_V2_Span.TimeEvent.MessageEvent.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Google_Devtools_Cloudtrace_V2_Span.TimeEvent.MessageEvent.TypeEnum] = [
    .unspecified,
    .sent,
    .received,
  ]
...
extension Google_Devtools_Cloudtrace_V2_Span.Link.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Google_Devtools_Cloudtrace_V2_Span.Link.TypeEnum] = [
    .unspecified,
    .childLinkedSpan,
    .parentLinkedSpan,
  ]
