...
struct Google_Api_LabelDescriptor {
  ...
  var valueType: Google_Api_LabelDescriptor.ValueType = .string
...
extension Google_Api_LabelDescriptor.ValueType: CaseIterable {
  ...
  static var allCases: [Google_Api_LabelDescriptor.ValueType] = [
    .string,
    .bool,
    .int64,
  ]
...
extension Google_Api_LabelDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LabelDescriptor"
  ...
  static func ==(lhs: Google_Api_LabelDescriptor, rhs: Google_Api_LabelDescriptor) -> Bool {
