...
public struct Google_Cloud_Aiplatform_V1_Artifact: Sendable {
  ...
  public var state: Google_Cloud_Aiplatform_V1_Artifact.State = .unspecified
  ...
  public enum State: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Google_Cloud_Aiplatform_V1_Artifact.State] = [
      .unspecified,
      .pending,
      .live,
    ]
...
extension Google_Cloud_Aiplatform_V1_Artifact: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    13: .same(proto: "state"),
    14: .standard(proto: "schema_title"),
    15: .standard(proto: "schema_version"),
    16: .same(proto: "metadata"),
    17: .same(proto: "description"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 14: try { try decoder.decodeSingularStringField(value: &self.schemaTitle) }()
      case 15: try { try decoder.decodeSingularStringField(value: &self.schemaVersion) }()
      case 16: try { try decoder.decodeSingularMessageField(value: &self._metadata) }()
      case 17: try { try decoder.decodeSingularStringField(value: &self.description_p) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.schemaTitle.isEmpty {
      try visitor.visitSingularStringField(value: self.schemaTitle, fieldNumber: 14)
    }
    if !self.schemaVersion.isEmpty {
      try visitor.visitSingularStringField(value: self.schemaVersion, fieldNumber: 15)
    }
    try { if let v = self._metadata {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 16)
    } }()
    if !self.description_p.isEmpty {
      try visitor.visitSingularStringField(value: self.description_p, fieldNumber: 17)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Aiplatform_V1_Artifact, rhs: Google_Cloud_Aiplatform_V1_Artifact) -> Bool {
...
extension Google_Cloud_Aiplatform_V1_Artifact.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
